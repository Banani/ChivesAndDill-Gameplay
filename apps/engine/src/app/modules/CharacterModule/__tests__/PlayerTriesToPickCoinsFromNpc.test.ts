...
describe('PlayerTriesToPickCoinsFromNpc', () => {
    it.skip('Player should get coins when he is picking it up', () => {
    ...
    it.skip('Player should get error if coins are already taken', () => {
        // const { engineManager, players, randomGeneratorService } = setupEngine();
    ...
    it.skip('Player should get error if tries to pick coins from corpse that is not opened by him', () => {
        // const { engineManager, players, randomGeneratorService } = setupEngine();
        // (randomGeneratorService.generateNumber as jest.Mock).mockReturnValue(0);
