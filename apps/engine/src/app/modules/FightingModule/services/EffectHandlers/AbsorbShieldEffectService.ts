...
import { ApplyTargetSpellEffectEvent, EngineEventHandler } from '../../../../types';
import { AbsorbShieldEffect } from '../../../../types/Spell';
import { AbsorbShieldValueChangedEvent, FightingEngineEvents, TakeAbsorbShieldValueEvent } from '../../Events';
...
export class AbsorbShieldEffectService extends EventParser {
   ...
   constructor() {
      ...
      this.eventsToHandlersMap = {
         ...
         [FightingEngineEvents.TakeAbsorbShieldValue]: this.handleTakeAbsorbShieldValue,
      };
   }
